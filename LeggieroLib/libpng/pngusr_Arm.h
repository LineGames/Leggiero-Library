/* pngusr_Arm.h - user configuration for 32bit Arm Platform */

#ifndef __LEGGIERO__LIBRARY__LIBPNG__PNGUSR_ARM_H
#define __LEGGIERO__LIBRARY__LIBPNG__PNGUSR_ARM_H
