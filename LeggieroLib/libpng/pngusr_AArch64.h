/* pngusr_AArch64.h - user configuration for AArch64 Platform */

#ifndef __LEGGIERO__LIBRARY__LIBPNG__PNGUSR_AARCH64_H
#define __LEGGIERO__LIBRARY__LIBPNG__PNGUSR_AARCH64_H
